...
abstract class BaseMAP: RuleFamily() {
    ...
    fun encodeTransition(transitions: BooleanArray) = Base64.withPadding(Base64.PaddingOption.ABSENT).encode(
    ...
    @OptIn(ExperimentalEncodingApi::class)
    fun decodeTransition(base64: String) = Base64.withPadding(Base64.PaddingOption.ABSENT).decode(
