...
actual fun main() {
//    val search = CFind(
//        HROT("R2,C2,S6-9,14-20,B7-8,15-24,NM"), 2, 1, 8,
//        ShipSymmetry.EVEN, verbosity = 1, maxQueueSize = 1 shl 28,
//        searchStrategy = SearchStrategy.PRIORITY_QUEUE, minDeepeningIncrement = 10, numThreads = 8
//    )
//    search.search()
